...
<template>
    <v-sheet rounded elevation="1" class="mx-auto px-4 pt-0 pb-4">
        <h3 class="text-h6 mb-2 pt-1">
            ...
            <v-btn icon="mdi-arrow-right" variant="text" :aria-label="$t('View all skins')" :to="localePath('/skins')"></v-btn>
        </h3>
        <v-row class="skin-single-row">
            <v-slide-group>
                <skin-link-img class="ma-2" v-show="isHydrated && latestSkins" v-for="skin in latestSkins"

        ...
        <v-card title="Delete Skin?">
            ...
            <v-card-text>
                <v-row>
                    <v-col>
                        <div>
                            Are you sure you want to delete this skin? This action is irreversible and will remove the
                            skin from your account permanently.
                            <br/>
                            Alternatively, you can set the visibility to "Private" or "Unlisted" to hide the skin from
